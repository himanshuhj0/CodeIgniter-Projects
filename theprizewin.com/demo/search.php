...
<div id="content">
<h2 id="h2-results">ALL UAE Cars </h2>
<div id="search">
 <form method="GET">
        <input type="hidden" name="page" value="search" />
        <table>
          <tr>
            <td><select class="searchTreeLevel1" name="MakeModel[tree][0]">
...

	{
...

		{
            ...
            <td><select name="MakeModel[tree][1]" style="margin-left:38px;">
                <option value="">Model</option>
                <option value=""  ></option>
              </select></td>
                 
            <td> 
              <select class="searchList"  name="region" style="margin-left:20px;">
                <option value="">Sity</option>
    ...
    <tr>
      <td><select name="oblast">
          ...
          <tr>
            ...
            <td>
              <select class="searchList"  name="bodystyle" style="margin-left:40px;">
...
$mark=$_GET['MakeModel'];
$mark=$mark['tree'][0];
$model=$_GET['MakeModel'];
$model=$model['tree'][1];
$Price_from=$_GET['Price_from'];
$Price_to=$_GET['Price_to'];
$Year_from=$_GET['Year_from'];
$Year_to=$_GET['Year_to'];
$mileage_low=$_GET['mileage_low'];
$mileage_high=$_GET['mileage_high'];
$bodystyle=$_GET['bodystyle'];
$region=$_GET['region'];

if(!isset($_GET['page2'])) { $page=1; } else { $page=$_GET['page2']; }


require('inc/demo2.dubaimoon.com.php');
require('inc/uae.dubizzle.com.php');
require('inc/autos.souq.com.php');
...
$the_url1 = curPageURL();
$the_url1=preg_replace("/&page2=(.*)/", "", $the_url1);


$next=$page+1;
$prev=$page-1;
 echo '<div class="stranicirane">';
echo "<a href=\"$the_url1&page2=$prev\" class=\"left\" style=\"font-size:18px;\">Previous Page</a>";
echo '<p>Page:&nbsp;'.$page.'</p>';
echo "<a href=\"$the_url1&page2=$next\" class=\"right\" style=\"font-size:18px;\">Next Page</a>";
echo '</div>';
